...
import (
	...
	cost_graph_go_proto "github.com/lfch/tensorflow/tensorflow/go/core/framework/cost_graph_go_proto"
	...
	step_stats_go_proto "github.com/lfch/tensorflow/tensorflow/go/core/framework/step_stats_go_proto"
...
type RecvTensorRequest struct {
	...
	TransportOptions *any1.Any `protobuf:"bytes,6,opt,name=transport_options,json=transportOptions,proto3" json:"transport_options,omitempty"`
...
func (x *RecvTensorRequest) GetTransportOptions() *any1.Any {
	if x != nil {
...
type RecvTensorResponse struct {
	...
	TransportOptions *any1.Any `protobuf:"bytes,4,opt,name=transport_options,json=transportOptions,proto3" json:"transport_options,omitempty"`
...
func (x *RecvTensorResponse) GetTransportOptions() *any1.Any {
	if x != nil {
		return x.TransportOptions
	}
	return nil
...
type RecvBufRequest struct {
	...
	TransportOptions *any1.Any `protobuf:"bytes,7,opt,name=transport_options,json=transportOptions,proto3" json:"transport_options,omitempty"`
...
func (x *RecvBufRequest) GetTransportOptions() *any1.Any {
	if x != nil {
		return x.TransportOptions
	}
	return nil
...
func (x *RecvBufResponse) GetTransportOptions() *any1.Any {
	if x != nil {
		return x.TransportOptions
	}
	return nil
