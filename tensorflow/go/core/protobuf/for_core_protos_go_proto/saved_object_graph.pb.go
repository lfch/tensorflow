...
import (
	...
	variable_go_proto "github.com/lfch/tensorflow/tensorflow/go/core/framework/variable_go_proto"
...
type SavedObject struct {
	...
	SerializedUserProto *any1.Any `protobuf:"bytes,14,opt,name=serialized_user_proto,json=serializedUserProto,proto3" json:"serialized_user_proto,omitempty"`
...
func (x *SavedObject) GetSerializedUserProto() *any1.Any {
	if x != nil {
