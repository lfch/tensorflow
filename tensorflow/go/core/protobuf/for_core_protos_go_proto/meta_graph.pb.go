...
type MetaGraphDef_MetaInfoDef struct {
	...
	AnyInfo *any1.Any `protobuf:"bytes,3,opt,name=any_info,json=anyInfo,proto3" json:"any_info,omitempty"`
...
func (x *MetaGraphDef_MetaInfoDef) GetAnyInfo() *any1.Any {
	if x != nil {
		return x.AnyInfo
	}
	return nil
...
func (x *CollectionDef_AnyList) GetValue() []*any1.Any {
	if x != nil {
		return x.Value
	}
	return nil
